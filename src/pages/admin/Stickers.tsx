...
import { Printer, Plus, Tag } from "lucide-react";
...
import { StickerData, DEFAULT_SPECS, DEFAULT_DISCLAIMERS, emptyStickerData } from "@/components/admin/stickers/types";
...
const AdminStickers = () => {
  ...
  const loadFromProduct = (productId: string, stickerIndex: number) => {
    ...
    // Build a product page URL for QR
    const baseUrl = window.location.origin;
    const qrCodeUrl = `${baseUrl}/product/${product.id}`;
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Generate packaging stickers with logos, QR codes & specs (3 per A4)</p>
        </div>
